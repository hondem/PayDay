...
export async function up(knex: Knex): Promise<any> {
    ...
    CREATE TABLE m.parametre (
        ...
        "13_plat_obdobie1" float NOT NULL,
        "13_plat_obdobie2" float NOT NULL,
        "13_plat_obdobie3" float NOT NULL,
      ...
      COMMENT ON COLUMN m.parametre.datum IS ' - datum platnosti od - od kedy platia hodnoty v zazname';
      ...
      COMMENT ON COLUMN m.parametre.zc_sadzba_sp_np IS '  - sadzba v percentach pre nemocenske poistenie zamestnanca';
      COMMENT ON COLUMN m.parametre.zc_sadzba_sp_dp_s IS ' - sadzba v percentach pre dochodkove poistenie starobne zamestnanca';
      COMMENT ON COLUMN m.parametre.zc_sadzba_sp_dp_i IS ' - sadzba v percentach pre dochodkove poistenie invalidne zamestnanca';
      COMMENT ON COLUMN m.parametre.zc_sadzba_sp_pvn IS ' - sadzba v percentach pre poistenie v nezamestnanosti zamestnanca';
      COMMENT ON COLUMN m.parametre.zl_sadzba_zp IS '  - sadzba v percentach pre zdravotne poistenie zamestnavatel';
      COMMENT ON COLUMN m.parametre.zl_sadzba_sp_np IS '  - sadzba v percentach pre nemocenske poistenie zamestnavatel';
      COMMENT ON COLUMN m.parametre.zl_sadzba_sp_dp_s IS ' - sadzba v percentach pre dochodkove poistenie starobne zamestnavatel';
      COMMENT ON COLUMN m.parametre.zl_sadzba_sp_dp_i IS ' - sadzba v percentach pre dochodkove poistenie invalidne zamestnavatel';
      COMMENT ON COLUMN m.parametre.zl_sadzba_sp_pvn IS ' - sadzba v percentach pre poistenie v nezamestnanosti zamestnavatel';
      ...
      COMMENT ON COLUMN m.pametre.mzda_min_hod1 IS ' - minimalna mzda hodinova pre kategoriu 1 ';
      COMMENT ON COLUMN m.pametre.mzda_min_hod2 IS ' - minimalna mzda hodinova pre kategoriu 2';
      COMMENT ON COLUMN m.pametre.mzda_min_hod3 IS ' - minimalna mzda hodinova pre kategoriu 3';
      COMMENT ON COLUMN m.pametre.mzda_min_hod4 IS ' - minimalna mzda hodinova pre kategoriu 4';
      COMMENT ON COLUMN m.pametre.mzda_min_hod5 IS ' - minimalna mzda hodinova pre kategoriu 5';
      COMMENT ON COLUMN m.pametre.mzda_min_hod6 IS ' - minimalna mzda hodinova pre kategoriu 6';
      COMMENT ON COLUMN m.pametre.mzda_min_mes1 IS ' - minimalna mzda mesacnaa pre kategoriu 1';
      COMMENT ON COLUMN m.pametre.mzda_min_mes2 IS ' - minimalna mzda mesacnaa pre kategoriu 2';
      COMMENT ON COLUMN m.pametre.mzda_min_mes3 IS ' - minimalna mzda mesacnaa pre kategoriu 3';
      COMMENT ON COLUMN m.pametre.mzda_min_mes4 IS ' - minimalna mzda mesacnaa pre kategoriu 4';
      COMMENT ON COLUMN m.pametre.mzda_min_mes5 IS ' - minimalna mzda mesacnaa pre kategoriu 5';
      COMMENT ON COLUMN m.pametre.mzda_min_mes6 IS ' - minimalna mzda mesacnaa pre kategoriu 6';
      ...
      COMMENT ON COLUMN m.parametre.13_plat_obdobie1 IS ' - 13 plat rok1';
      COMMENT ON COLUMN m.parametre.13_plat_obdobie2 IS ' - 13 plat rok2';
      COMMENT ON COLUMN m.parametre.13_plat_obdobie3 IS ' - 13 plat rok3';
