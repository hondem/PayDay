  ...
  switch (formType) {
    case 'employment': return (
      <Grid gridTemplateColumns={['1fr', null, null, '1fr 1fr']} gridGap="s6" mb="s6">
                ...
                <div>
                  <Label htmlFor="pracovna_schopnost_znizena1">Znížená pracovná schopnosť 1. kategória</Label>
                  <Input name="pracovna_schopnost_znizena1" type="checkbox"/>
                  <ErrorMessage name="pracovna_schopnost_znizena1" />
                </div>

                <div>
                  <Label htmlFor="pracovna_schopnost_znizena2">Znížená pracovná schopnosť 2. kategória</Label>
                  <Input name="pracovna_schopnost_znizena2" type="checkbox"/>
                  <ErrorMessage name="pracovna_schopnost_znizena2" />
                </div>

                <div>
                  <Label htmlFor="pracovna_schopnost_znizena3">Znížená pracovná schopnosť 3. kategória</Label>
